...
namespace LouvreLIS_Management
{
    public partial class Main : Form
    {
        ...
        public void getlogindata(Account asd)
        {
            ...
            account = asd;
            AccountInfoToolStripMenuItem_Click(null, null);
            AccountInfoToolStripMenuItem.Visible = true;
            AccountManagementToolStripMenuItem.Visible = (asd.Employee.EmployeeType == 1 || asd.Employee.EmployeeType == 2);
            StaffAccountManagementToolStripMenuItem.Visible = (asd.Employee.EmployeeType == 2);
        }
        ...
        {
            ShowPanel.Controls.Clear();
            VisitorAccountManagementForm visitoraccountManagementForm = new VisitorAccountManagementForm();
            visitoraccountManagementForm.TopLevel = false;
            ShowPanel.Controls.Add(visitoraccountManagementForm);
            visitoraccountManagementForm.Show();
        }

        private void StaffAccountManagementToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowPanel.Controls.Clear();
            StaffAccountManagementForm staffAccountManagement = new StaffAccountManagementForm();
            staffAccountManagement.TopLevel = false;
            ShowPanel.Controls.Add(staffAccountManagement);
            staffAccountManagement.ssd = account.EmailAddress; ;
            staffAccountManagement.Show();
        }
    }
}
